...
class CostMonitor:
    ...
    def track_token_usage(
        ...
        try:
            ...
            if not cached:  # Only track cost for non-cached responses
                self._add_metric(MetricType.CONVERSATION_COST, cost_estimate, 'None', dimensions, metadata)
    ...
    def track_vector_query(
        ...
        try:
            ...
            cost_estimate = 0.0 if cache_hit else query_count * self.pricing['s3_vectors']['query_cost']
    ...
    def track_cache_performance(
        ...
        try:
            ...
            if hit and cost_saved > 0:
                ...
                self._add_metric(MetricType.CONVERSATION_COST, -cost_saved, 'None', savings_dimensions, metadata)
    ...
    def _calculate_token_cost(self, input_tokens: int, output_tokens: int, model_id: str) -> float:
        ...
        try:
            ...
            if model_id == 'amazon.nova-lite-v1:0':
                normalized_model_id = 'amazon.nova-lite-v1'
            elif model_id == 'amazon.titan-embed-text-v1':
                normalized_model_id = 'amazon.titan-embed-text-v1'
            
            model_pricing = self.pricing.get(normalized_model_id, self.pricing.get('amazon.nova-lite-v1', {}))
